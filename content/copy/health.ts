...
export const health = {
  meta: {
    ...
    description:
      "The body is the balance sheet. JoySpan / AIWO at principal grade: 208 biomarkers, Test → Treat → Retest, and the 0.71 benchmark.",
  },
  ...
  stack: {
    ...
    layers: [
      ...
      { layer: "90-day method", component: "SIIS (back-end)", sees: "Quarterly visible progress" },
